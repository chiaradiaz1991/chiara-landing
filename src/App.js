      ...
      <div className="app-header">
        ...
        <div className="second-description">
          <p className="text-second-description">
            I'm a front-end developer from Buenos Aires, Argentina, based in Poland. I enjoy learning new things every day, not only related to software development. Also, I have a little background in graphic design and in my free time, I'm a digital illustrator. Some of the things I like the most are Astrology, tarot and tattoos.
          </p>
          <p className="text-second-description">
